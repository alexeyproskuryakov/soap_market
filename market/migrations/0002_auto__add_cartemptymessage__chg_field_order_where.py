...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CartEmptyMessage'
        db.create_table('market_cartemptymessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length='255')),
            ('page_name', self.gf('django.db.models.fields.CharField')(max_length='1')),
        ))
        db.send_create_signal('market', ['CartEmptyMessage'])
    ...
    def backwards(self, orm):
        # Deleting model 'CartEmptyMessage'
        db.delete_table('market_cartemptymessage')
    ...
    models = {
        ...
        'market.cartemptymessage': {
            'Meta': {'object_name': 'CartEmptyMessage'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_name': ('django.db.models.fields.CharField', [], {'max_length': "'1'"}),
